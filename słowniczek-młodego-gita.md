...
| Pojęcie | Wersja polska | Analogia |
| :--- | :--- | :--- |
...
### Jesteś Programistą (Naprawiasz Błąd)
...
2. Kliknij Prawy Przycisk Myszy -> **Discard changes**.
3. Potwierdź (czerwony przycisk).
